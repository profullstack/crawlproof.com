  ...
  const steps: ChecklistStep[] = [
    {
      ...
      cta: hasFirstScan
        ? { href: `/projects/${id}/scans`, label: "View scans" }
        : { href: `/projects/${id}`, label: "Run a scan" },
    },
    {
      id: "stats-tracker",
      ...
      cta: { href: `/projects/${id}/stats`, label: trackerEnabled ? "Open Stats tab" : "Enable tracker" },
