    ...
    <div className="mx-auto max-w-4xl space-y-8">
      ...
      {(previews ?? []).length > 0 && (
        <section className="rounded border border-amber-500/40 bg-amber-500/5 p-4">
          ...
          <p className="mt-1 text-xs text-[var(--color-muted)]">
            These articles were generated by <em>Preview next post</em> and
            haven't been delivered to your webhook yet. Open one to review
            and click Publish to send it.
          </p>
