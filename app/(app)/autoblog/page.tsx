    ...
    return (
      <div className="mx-auto max-w-2xl">
        ...
        <p className="mt-2 text-[var(--color-muted)]">
          You haven't set up Autoblog yet.
        </p>
        <Link href="/autoblog/setup" className="btn btn-primary mt-4 inline-flex">
          Get started
        </Link>
      </div>
    );
    ...
    <div className="mx-auto max-w-4xl space-y-8">
      <header className="flex flex-wrap items-baseline justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-2">
          <Link href="/autoblog/setup" className="btn">
            Settings
          </Link>
          <Link href="/autoblog/history" className="btn">
            History
          </Link>
        </div>
      </header>
