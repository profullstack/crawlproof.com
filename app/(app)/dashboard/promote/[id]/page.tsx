  ...
  return (
    <div className="mx-auto max-w-4xl">
      ...
      <div className="flex items-center justify-between gap-4">
        <div>
          <Link href="/dashboard/promote" className="text-sm text-[var(--color-muted)] hover:text-[var(--color-fg)]">
            &larr; All lists
          </Link>
      ...
      <div className="mt-4 flex flex-wrap gap-3">
        ...
        {list.pause_reason === "insufficient_credits" && (
          <Link href="/dashboard/settings/billing" className="badge badge-fail">
