    ...
    <div className="mx-auto max-w-4xl">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Link href="/dashboard/promote/accounts" className="btn">
            Manage accounts
          </Link>
          <Link href="/dashboard/promote/new" className="btn btn-primary">
            New promote list
          </Link>
        </div>
      </div>
      ...
      {accountCount === 0 && (
        <div className="card mt-6 border-[var(--color-warn)] bg-[var(--color-warn)]/10 p-4 text-sm">
          ...
          <Link href="/dashboard/promote/accounts" className="text-[var(--color-accent)] font-semibold">
            Connect an account
          </Link>{" "}
          to start promoting.
        </div>
      ...
      {lists.length === 0 ? (
        <div className="card mt-6 p-8 text-center text-[var(--color-muted)]">
          ...
          <Link href="/dashboard/promote/new" className="text-[var(--color-accent)]">
