  ...
  if (!site) {
    return (
      <div className="mx-auto max-w-2xl">
        ...
        <Link
          href={`/dashboard/projects/${projectId}/autoblog/setup`}
    ...
    <div className="mx-auto max-w-4xl space-y-8">
      <header className="flex flex-wrap items-baseline justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-2">
          <Link href={`/dashboard/projects/${projectId}/autoblog/plan`} className="btn">
            Plan
          </Link>
          ...
          <Link href={`/dashboard/projects/${projectId}/autoblog/backlinks`} className="btn">
            Backlinks
          </Link>
        </div>
      </header>
          ...
          <>
            ...
            <ul className="mt-3 space-y-1 text-sm">
              {previews!.map((p: any) => (
                <li key={p.id}>
                  <Link
                    href={`/dashboard/projects/${projectId}/autoblog/articles/${p.id}`}
            ...
            {recent!.map((a: any) => (
              <li key={a.id} className="px-3 py-2 text-sm">
                <div className="flex items-baseline justify-between gap-3">
                  <Link
                    href={`/dashboard/projects/${projectId}/autoblog/articles/${a.id}`}
