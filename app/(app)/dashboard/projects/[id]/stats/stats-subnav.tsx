...
export function StatsSubnav({ projectId }: { projectId: string }) {
  ...
  const tabs = [
    { label: "Overview", href: `/dashboard/projects/${projectId}/stats` },
    { label: "Integrations", href: `/dashboard/projects/${projectId}/stats/integrations` },
    { label: "Careers", href: `/dashboard/projects/${projectId}/stats/careers` },
  ];
